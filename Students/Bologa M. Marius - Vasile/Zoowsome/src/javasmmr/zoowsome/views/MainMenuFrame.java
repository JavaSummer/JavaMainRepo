 ...
 */
	public MainMenuFrame(final String title) {
		...
		slPanel.putConstraint(SpringLayout.NORTH,
				background, 0, SpringLayout.NORTH, pan);
		slPanel.putConstraint(SpringLayout.WEST, 
				background, 0, SpringLayout.WEST, pan);
		pan.add(background);
		...
		slPanel.putConstraint(SpringLayout.NORTH,
				btnAdd, 65, SpringLayout.NORTH, pan);
		slPanel.putConstraint(SpringLayout.WEST, 
				btnAdd, 93, SpringLayout.WEST, pan);
		pan.add(btnAdd);
		btnList = new JButton("List");
		slPanel.putConstraint(SpringLayout.NORTH,
				btnList, 150, SpringLayout.NORTH, pan);
		slPanel.putConstraint(SpringLayout.WEST, 
				btnList, 94, SpringLayout.WEST, pan);
		pan.add(btnList);
		btnSaveAndExit = new JButton("Save and Exit");
		slPanel.putConstraint(SpringLayout.NORTH, 
				btnSaveAndExit, 264, SpringLayout.NORTH, pan);
		slPanel.putConstraint(SpringLayout.WEST, 
				btnSaveAndExit, 69, SpringLayout.WEST, pan);
...
/**
 * 
 * @param a If the user clicks an onscreen button.
 */
