...
abstract public class Bird extends Animal{
	...
	private int avgFlightAltitude;
	 ...
	 public void encodeToXml(XMLEventWriter eventWriter) throws XMLStreamException {
		 ...
		 createNode(eventWriter, "flightAltitude", String.valueOf(getAvgFlightAltitude()));
		 createNode(eventWriter, "migrates", String.valueOf(getMigrates()));
		 }
	 
	 public void decodeFromXml(Element element) {
		 setTakeCareOf(Boolean.valueOf(element.getElementsByTagName("flightAltitude").item(0).getTextContent()));
