...
public class ReptileController extends AbstractController {
	...
	private class SaveButtonActionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if ((!reptile.getName().equals("Enter name")) && (!reptile.getNrOfLegs().equals("Enter nrOfLegs"))
					&& (!reptile.getCost().equals("Enter cost"))
					&& (!reptile.getDanger().equals("Enter danger perc"))) {
