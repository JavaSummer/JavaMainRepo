...
public class BirdController extends AbstractController {
	...
	private class SaveButtonActionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if ((!bird.getName().equals("Enter name")) && (!bird.getNrOfLegs().equals("Enter nrOfLegs"))
					&& (!bird.getCost().equals("Enter cost")) && (!bird.getDanger().equals("Enter danger perc"))
					&& (!bird.getFlight().equals("Enter swim depth"))) {
