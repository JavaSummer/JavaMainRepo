...
public class CaretakerFrame extends ZooFrame {
	...
	public CaretakerFrame(String title) {
		...
		nameF = new JTextField("Enter the name here");
		...
		idF = new JTextField("Enter the ID here");
		...
		salaryF = new JTextField("Enter the salary here");
		...
		hoursF = new JTextField("Enter the working hours here");
		...
		slPanel.putConstraint(SpringLayout.NORTH, saveB, 175, SpringLayout.NORTH, pan);
