...
public class Dragonfly extends Insect {
	...
	public Dragonfly(final String animalName, final int numberOfLegs, final double maintenanceCost,
	...
	public Dragonfly(String v1, String v2, String v3, String v4, String v5, String v6) {
