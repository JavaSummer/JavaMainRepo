...
import javasmmr.zoosome.services.factories.employees.EmployeeFactory;
import javasmmr.zoosome.services.factories.employees.HumanFactory;
...
public class BigFactory {
	...
	/**
	 * Generates an animal with random parameters of the selected species and
	 * type
	 */
	...
	/**
	 * Generates an animal with random parameters of random species and random
	 * type
	 */
	...
	/**
	 * Generates an array of animals with random parameters random species and
	 * random type
	 */
	...
	/**
	 * Generates an array of animals with random parameters of selected species
	 * and random type
	 */
	...
	/**
	 * Generates a matrix of animals with random parameters of all species and
	 * all type evenly
	 */
	...
	public static void printDetails(Animal a) {
		if (a instanceof Mammal) {
			Mammal an = (Mammal) a;
			System.out.printf("%s has %d legs, %f normal body temperature, %f%% covered in hair, ", an.getName(),
					an.getNoOfLegs(), an.getNormalBodyTemp(), an.getPercBodyHair());
			...
			Bird an = (Bird) a;
			System.out.printf("%s has %d legs, ", an.getName(), an.getNoOfLegs());
			System.out.print("the fact that it migrates is " + an.getMigrates() + ", its average flight height is "
					+ an.getAvgFlightAltitude() + ", ");
		} else if (a instanceof Aquatic) {
			Aquatic an = (Aquatic) a;
			System.out.printf("%s has %d legs, %d average swim depth, lives in %s, ", an.getName(), an.getNoOfLegs(),
					an.getAvgSwimDepth(), an.getWaterType().toString());
		} else if (a instanceof Insect) {
			Insect an = (Insect) a;
			System.out.printf("%s has %d legs, ", an.getName(), an.getNoOfLegs());
			System.out.print("the fact that it flies is " + an.getCanFly() + ", the fact that it is dangerous is "
					+ an.getIsDangerous() + ", ");
	...
	public static void nicePrint(final String s, final int verticalEmptyCount, final int verticalFillerCount,
			final int horizontalFillerCount) {
