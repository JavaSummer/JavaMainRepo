...
public class Surgeonfish extends Aquatic {
	...
	private static final int DEFAULT_AVERAGE_SWIMMING_DEPTH = 27;
	...
	public Surgeonfish(final String animalName, final int numberOfLegs, final double maintenanceCost,
	...
	public Surgeonfish(String v1, String v2, String v3, String v4, String v5, String v6) {
		super(new String[] { v1, v2, v3, v4, v5, v6 });
	}

	public void encodeToXML(XMLEventWriter eventWriter) throws XMLStreamException {
		super.encodeToXML(eventWriter);
		createNode(eventWriter, Constants.XML_TAGS.DISCRIMINANT, String.valueOf(Constants.Animals.Aquatic.SURGEONFISH));
	}
}
