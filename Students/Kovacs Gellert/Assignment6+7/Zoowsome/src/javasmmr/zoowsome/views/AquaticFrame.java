...
public class AquaticFrame extends ZooFrame {
	...
	private JSpinner avgSwimDepthField;
	private JComboBox<String> waterTypeBox;
	...
	public int getAvgSwimDepth() {
		return (int)avgSwimDepthField.getValue();
	}

	public WaterType getWaterType() {
		if (waterTypeBox.getSelectedItem().toString().equals("SALT")) 
