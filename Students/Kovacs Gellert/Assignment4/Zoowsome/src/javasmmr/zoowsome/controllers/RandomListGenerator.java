...
public class RandomListGenerator {
	...
	public ArrayList<Caretaker> getRandomCaretakers(int nrOfEmployees) throws Exception {
		CaretakerFactory caretakerFactory = new CaretakerFactory();
		ArrayList<Caretaker> ctList = new ArrayList<Caretaker>();
		
		for (int i = 0; i < nrOfEmployees; i++) {
			ctList.add((Caretaker)caretakerFactory.getEmployee(Constants.Employees.Caretaker));
		}
